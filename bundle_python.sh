...
echo ""
echo -e "  Next step:  ${BOLD}npm run build${RESET}"
echo -e "  Verify:      ${BOLD}du -sh src-tauri/target/release/bundle/macos/Journal\\ Buddy.app/Contents/Resources/python${RESET}"
echo ""
